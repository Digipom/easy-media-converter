...
public class AdjustVolumeActionViewModel extends AndroidViewModel {
    private MediaItem mediaItem;

    public AdjustVolumeActionViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    String getDefaultOutputFilename() {
        return FilenameUtils.appendToFilename(mediaItem.getFilename(),
                getAppendNamingForOutput(getApplication(), EditAction.ADJUST_VOLUME));
    }
}